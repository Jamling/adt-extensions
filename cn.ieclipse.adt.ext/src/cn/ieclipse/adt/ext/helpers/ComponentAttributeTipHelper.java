        ...
        try {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (attr != null) {
                    ...
                    String src = (oos.toString().replace("<?xml version=\"1.0\" encoding=\"UTF-8\"?>", ""));
                    StringBuilder dst = new StringBuilder();
                    dst.append("<html><head>");
                    dst.append("<base href=\"#\" />");//target=\"_blank\" 
                    dst.append("</head><body>");
                    dst.append(src);
                    dst.append("</body></html>");
                    attr.setTip(dst.toString());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
