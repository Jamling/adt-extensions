...
import cn.ieclipse.adt.ext.jdt.SourceGenerator;
import cn.ieclipse.adt.ext.jdt.JavaSelection.TypeMapping;
...
public class NewOrmProviderWizardPage extends NewProviderWizardPage {
    ...
    protected void createTypeMembers(IType newType, ImportsManager imports,
        ...
        for (TypeMapping map : list) {
            ...
            imports.addImport(map.getType().getFullyQualifiedName());
            tables.add("Aorm.createTable(db, " + map.getType().getElementName() + ".class);"); 
        }
        ...
        try {
            ...
            imports.addImport("cn.ieclipse.aorm.Aorm");
